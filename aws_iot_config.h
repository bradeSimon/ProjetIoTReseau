...
#define AWS_IOT_MQTT_CLIENT_ID         "Pine64Thing" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "Pine64Thing" ///< Thing Name of the Shadow this device is associated with
